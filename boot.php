...
define( 'FACTORY_CLEARFY_000', '2.0.7' );
...
if ( is_admin() ) {
	...
	require( FACTORY_CLEARFY_000_DIR . '/pages/class-clearfy-more-features.php' );
	require( FACTORY_CLEARFY_000_DIR . '/pages/class-clearfy-pages.php' );
	require( FACTORY_CLEARFY_000_DIR . '/pages/class-clearfy-license.php' );
}