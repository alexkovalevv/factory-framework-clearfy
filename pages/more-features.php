				...
				<div class="row">
					<div class="col-sm-4">
						<div class="wbcr-factory-feature-box">
							...
							<h3><?php _e('Code cleaning', 'wbcr_factory_clearfy_000')?></h3>

							<p><?php _e('Clears the source code of the page from unused code.', 'wbcr_factory_clearfy_000')?></p>
						</div>
					</div>
					<div class="col-sm-4">
						<div class="wbcr-factory-feature-box">
							...
							<h3><?php _e('Improve SEO', 'wbcr_factory_clearfy_000')?></h3>

							<p><?php _e('Removes duplicate pages, closes external links, changes the headers of the server.', 'wbcr_factory_clearfy_000')?></p>
						</div>
					</div>
					<div class="col-sm-4">
						<div class="wbcr-factory-feature-box">
					...
					<div class="col-sm-4">
						<div class="wbcr-factory-feature-box">
							...
							<h3><?php _e('Disable comments', 'wbcr_factory_clearfy_000')?></h3>

							<p><?php _e('Disables comments on the entire site or on specific pages.', 'wbcr_factory_clearfy_000')?></p>
						</div>
					</div>
					<div class="col-sm-4">
						<div class="wbcr-factory-feature-box">
							...
							<h3><?php _e('Manage updates', 'wbcr_factory_clearfy_000')?></h3>

							<p><?php _e('Enables or disables automatically updates for plugins, themes and core. It is also possible
							to disable all updates.', 'wbcr_factory_clearfy_000')?></p>
						</div>
					</div>
					<div class="col-sm-4">
						<div class="wbcr-factory-feature-box">
							...
							<h3><?php _e('Manage widgets', 'wbcr_factory_clearfy_000')?></h3>

							<p><?php _e('Allows you to remove unused widgets.', 'wbcr_factory_clearfy_000')?></p>
						</div>
					</div>
					<div class="col-sm-4">
						<div class="wbcr-factory-feature-box">
							...
							<h3><?php _e('Speed Optimization', 'wbcr_factory_clearfy_000')?></h3>

							<p><?php _e('Increases performance by disabling unused functions and reducing the number of requests.', 'wbcr_factory_clearfy_000')?></p>
						</div>
					</div>
					<div class="col-sm-4">
						<div class="wbcr-factory-feature-box">
					...
					<div class="col-sm-4">
						<div class="wbcr-factory-feature-box">
							...
							<h3><?php _e('Easy setup', 'wbcr_factory_clearfy_000')?></h3>

							<p><?php _e('In quick mode, you can easily configure the plugin according to your needs.', 'wbcr_factory_clearfy_000')?></p>
						</div>
					</div>
				</div>
